...
export default function Header({ 
  ...
  return (
    <header className="border-b border-slate-800/80 bg-slate-950/90 sticky top-0 z-40 backdrop-blur-2xl">
          ...
          <div className="flex items-center space-x-3.5">
            ...
            <div className="flex flex-col justify-center">
              <div className="flex items-center space-x-2">
                <span className="text-[10px] font-bold tracking-widest text-teal-400 bg-teal-950/80 border border-teal-800/80 px-2 py-0.5 rounded">
