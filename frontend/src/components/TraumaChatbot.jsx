          ...
          <div className="grid grid-cols-2 gap-2">
            {SAMPLE_PRESETS.map((scenario) => (
              <button
                ...
                className="text-left p-3 bg-slate-950 hover:bg-slate-800/80 border border-slate-800 hover:border-teal-500/40 rounded-2xl transition-all group shadow-sm"
              >
                <div className="flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-200 group-hover:text-teal-300">{scenario.name}</span>
                  <span className="text-[9px] font-medium px-2 py-0.5 rounded bg-slate-900 text-slate-400 border border-slate-700">{scenario.category}</span>
                </div>
